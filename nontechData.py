nontechJson = [{
        ...
        'date': "23/08",
        'time': "10:00 AM",
        'venue': "C21, IIIT Delhi",
        'prize': "Worth 20K",
        'team': "4 - (1 designer & 3 writers)",
        ...
        'date': "23/08 - 24/08",
        'time': "10:00 AM",
        'venue': "Glassroom, Old Acad Block, IIIT Delhi",
        'prize': "Worth 6K",
        'team': "1 Member",
        ...
        'date': "24/08",
        'time': "8:30 AM",
        'venue': "2nd & 3rd Floor, Library, IIIT Delhi",
        'prize': "Worth 20K",
        'team': "4 Members",
        ...
        'date': "24/08",
        'time': "8:30 AM",
        'venue': "A106 & B105, New Acad Block, IIIT Delhi",
        'prize': "Worth 35K",
        'team': "1 Member",
    	...
    	'rules': [ 
            "1. An onsite quiz will be conducted which will test the cricketing knowledge of the participating teams. Use of unfair means and cheating during the quiz will lead to disqualification.",
            "2. Based on the quiz scores, 8 teams will be shortlisted (a tie breaker round will be conducted in case of a tie). Those teams will be allotted an IPL team (randomly) and they’ll compete in the auction round.",
            "3. Every team will be having a fixed purse amount of 100 Crores.",
            "4. About 150 players (men) will be up for the auction, each of them with a fixed base price.",
            "5. Players in the auction pool will be sorted into groups based on their role (batsman, bowler, all rounder and wicket keeper).",
            "6. Player’s name will be called out and teams will start raising their team paddles in order to raise a bid for that player.The bidding will start from the base price of the player and will go on for as long as it has to. The team with the highest bid will get the player.",
            "7. The amount by which the bid is raised depends on the current price as follows:-",
            "<ul>",
            "<li>Current Price below 1 Cr: 5 lakhs</li>",
            "<li>Current Price below 1 Cr and 10 Cr: 20 lakhs</li>",
            "<li>Current Price above 10 Cr: 50 lakhs</li>",
            "</ul>",
            "8. If no team raises the paddle for a considerable period of time, the player will go unsold. The unsold players will then go back into the pot and can be bought later on in the day as well.",
            "9. The teams are supposed to prepare a squad with the following features:-",
            "<ul>",
            "<li>Squad Strength:- 15-17</li>",
            "<li>At least 1 wicket keeper</li>",
            "<li>Overseas players:- 3-6</li>",
            "</ul>",
            "10. Failing to meet the criteria given above will lead to disqualification.",
            "11. Every player will be having a rating associated with him (based on his career records and recent form). We won’t reveal the ratings to the participants. ",
            "12. After the auction, power ratings of all the 8 teams will be calculated which will be equal to the sum of the ratings of all the players in the squad.",
            "13. The top 3 powerful teams will be rewarded. "
            ]
    }, {
        'id': 13,
        'name': 'Poker',
        ...
        'date': "23/08 - 24/08",
        'time': "9:30 AM",
        'venue': "Ground Floor, Library, IIIT-Delhi",
        'prize': "TBA",
        'team': "1 Member",
        ...
        'date': "23/08 - 24/08",
        'time': "11:00 AM",
        'venue': "C22, C23, C24, Acad Block, IIIT Delhi",
        'prize': "Worth 10K",
        'team': "1 Member",
